...
public class ProjectBO {
	...
	public Project create(String uploadPath, Part part, int user_id, String name, String description) {
        ...
        try {
			...
			Project project = new Project(user_id, name, description, fileName, "output_"+ fileName, 0);
			int id = projectDAO.createProject(project);
			project.setId(id);
	        Track track = new Track(filePath,videoOutputPath , id);
	        track.start();
	        System.out.print(id);
...
class Track extends Thread {
    ...
    public Track(String inputPath, String outputPath, int id) {
